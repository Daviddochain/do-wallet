(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      ".do-market-badge{font-weight: 700;font-size:12px;line-height:1;padding:7px 9px;border-radius:999px;background:#131017;color:#d8c9ff;border:1px solid rgba(255,255,255,.12)}",
      ...
      ".do-market-percent-cell{display:inline-flex;align-items:center;justify-content:flex-end;gap:5px;min-width:72px;font-weight: 700;white-space:nowrap}",
      ...
      ".do-market-metrics span{display:block;color:#b8a7d9;font-size:12px;font-weight: 700;text-transform:uppercase}",
